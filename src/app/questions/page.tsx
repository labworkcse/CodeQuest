...
export default function QuestionsPage() {
  ...
  const totalQuestions = "24,222,735"; // Placeholder

  return (
    <AppLayout mainContentClassName="lg:max-w-none !px-0 sm:!px-4"> {/* Override default max-width */}
      <div className="flex justify-between items-center mb-6">
         <div>
          <h1 className="text-2xl md:text-3xl font-semibold text-foreground">All Questions</h1>
